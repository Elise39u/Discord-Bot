...
async def onHelpMessage(message): 
  ...
  await EmbedBuilder.BuildEmbed(message, "I found my commands. *Whistele noises*", "We have the following commands but first its good to know my prefix is 39M!. Most commands are also case senstive so be aware \n 🎀 39M!Help --> Show this message \n 🎀 39M!Hello --> Says hello to you \n 🎀 39M!Joke --> Gets you a random dad joke \n 🎀 39M!Socials --> See Elise her offical known socials \n 🎀 39M!MyAvatar --> Get your avatar or someones you want *Can only get up to one tag per message* \n 🎀 39M!8Ball --> Get a response from the beloved 8ball *requires a question*", "https://i.kym-cdn.com/photos/images/original/001/139/222/6b8.gif", 0xfe3ee4, "🎀 Someone asked for help? 🎀", None)
...
async def GetAvatar(message, member):
  ...
  await EmbedBuilder.BuildEmbed(message, "Found {0.display_name} avatar".format(member), "I found the following avatar for you", member.avatar_url, 0xfe3ee4, "🎀 Pictures Left and right? 🎀", None)
