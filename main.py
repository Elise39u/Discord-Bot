...
async def on_message(message):
            ...
            if word in message.content.lower():
                ...
                if (roleCheck == False):
                    ...
                    await message.channel.send(
                        'https://cdn.discordapp.com/attachments/997798399728418867/997798441004568597/unknown.png'
                    )
                    await message.channel.send(
    ...
    if "objection" in message.content:
        await message.channel.send(
            'https://cdn.discordapp.com/attachments/699557641818734638/1080410862629703690/3aixx5.png'
        )
    ...
    if message.content.startswith('39M!Point'):
        await message.delete()
        await message.channel.send(
            'https://cdn.discordapp.com/attachments/847134276448288830/1038796885240066089/point.png'
        )
    ...
    if message.content.startswith('39M!OwO') and len(message.content) > 7:
        ...
        await message.channel.send(
            text_to_owo(
                f"{message.author.display_name} please add a text for me to OWO. Love Miku"
            ))

    if message.content.startswith('39M!Say') and len(
            message.content
    ) > 7 and "@everyone" not in message.content and "@here" not in message.content:
        await message.delete()
        await message.channel.send(message.content[7:])
    elif message.content.startswith('39M!Say') and len(
            message.content) > 7 and "@everyone" in message.content:
        await message.delete()
        await message.channel.send(
            f"{message.author} please dont use the everyone tag")
    elif message.content.startswith('39M!Say') and len(
            message.content) > 7 and "@here" in message.content:
        await message.delete()
        await message.channel.send(
            f"{message.author} please dont use the here tag")
    elif message.content.startswith('39M!Say') and len(message.content) <= 7:
        await message.delete()
        await message.channel.send(
            f"{message.author} im not gonna say my own command uwu!")
